...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        "  -?                     " + _("This help message") + "\n" +
        "  -conf=<file>           " + _("Specify configuration file (default: betacoin.conf)") + "\n" +
        "  -pid=<file>            " + _("Specify pid file (default: betacoind.pid)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Betacoin Wiki for SSL setup instructions)") + "\n" +
